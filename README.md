...
My main challenge was setting up the environment for web development. I haven't done web development before so it was hard to figure out how to set up apahce, php, and mysql. Also I only had a basic knowledge of sql using the terminal so I had to learn that as well.
